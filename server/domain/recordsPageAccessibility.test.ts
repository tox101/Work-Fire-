...
vi.mock("../../client/src/lib/trpc", () => ({
  trpc: { useUtils: () => ({ workspace: { recordSearch: { invalidate: vi.fn() }, recordDetail: { invalidate: vi.fn() }, recordTagOptions: { invalidate: vi.fn() }, recordTagStats: { invalidate: vi.fn() }, recentRecordTags: { invalidate: vi.fn() }, savedRecordSearches: { invalidate: vi.fn() }, pinnedRecordSummaries: { invalidate: vi.fn() } } }), workspace: { overview: { useQuery: queries.overview }, recordSearch: { useQuery: queries.recordSearch }, recordDetail: { useQuery: queries.recordDetail }, recordTagOptions: { useQuery: queries.recordTagOptions }, recordTagStats: { useQuery: queries.recordTagStats }, recentRecordTags: { useQuery: queries.recentRecordTags }, savedRecordSearches: { useQuery: queries.savedRecordSearches }, createSavedRecordSearch: { useMutation: () => ({ mutate: vi.fn(), isPending: false }) }, deleteSavedRecordSearch: { useMutation: () => ({ mutate: vi.fn(), isPending: false }) }, moveSavedRecordSearch: { useMutation: () => ({ mutate: vi.fn(), isPending: false }) }, deleteRecord: { useMutation: () => ({ mutate: vi.fn(), isPending: false }) }, setRecordPinned: { useMutation: () => ({ mutate: vi.fn(), isPending: false }) }, addRecordTag: { useMutation: () => ({ mutate: vi.fn(), isPending: false }) }, removeRecordTag: { useMutation: () => ({ mutate: vi.fn(), isPending: false }) } } },
}));
