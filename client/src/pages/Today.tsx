...
export default function Today() {
  ...
  return (
    <div className="mx-auto max-w-5xl pb-16">
      ...
      {viewMode === "day" && openRecordMode && <section className="mt-3"><CapturePanel mode={openRecordMode} workspace={data} recordDate={day} onComplete={() => setOpenRecordMode(null)} /></section>}
